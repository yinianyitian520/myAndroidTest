...
public class SildingFinishLayout extends RelativeLayout implements  
    ...
    /** 
     * touch的View是否是ListView， 例如ListView, GridView等其子类
     *  
     * @return 
     */  
    private boolean isTouchOnListView() {
        return touchView instanceof ListView ? true : false;
    }
    ...
    public boolean onTouch(View v, MotionEvent event) {  
        ...
        case MotionEvent.ACTION_MOVE:  
            ...
            if (Math.abs(moveX - downX) > mTouchSlop  
                ...
                if (isTouchOnListView()||isTouchOnWebView()) {
            ...
            if (moveX - downX >= 0 && isSilding) {  
                ...
                if (isTouchOnScrollView() || isTouchOnListView()||isTouchOnWebView()) {
                    return true;
                }
            }  
            break;  
